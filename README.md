...
Use the plugin script with the arguments `--url https://s3.amazonaws.com/eskka/eskka-0.1.0.zip --install eskka`.
...
Then use the plugin script with the arguments `--url file:///path/to/eskka-0.1.0.zip --install eskka`.
